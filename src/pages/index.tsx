  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="With Construction Tool Rental v2, individual customers can experience the ease of renting construction tools from a centralized supplier with multiple outlets. Simplifying your construction needs."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`With Construction Tool Rental v2, individual customers can experience the ease of renting construction tools from a centralized supplier with multiple outlets. Simplifying your construction needs.`}
            </Text>
            <Box
